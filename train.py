...
parser = argparse.ArgumentParser(description='Bird Similarity using Triplet Loss')
...
parser.add_argument('--train-root-dir', default='/content/train_terbaru', type=str,
                    help='path to train root dir')
parser.add_argument('--valid-root-dir', default='/content/valid_terbaru', type=str,
                    help='path to valid root dir')
parser.add_argument('--train-csv-name', default='/content/train_terbaru.csv', type=str,
                    help='list of training images')
parser.add_argument('--valid-csv-name', default='/content/valid_terbaru.csv', type=str, help='list of validtion images')
...
def main():
    ...
    model = BirdNetModel(pretrained=pretrain)
    model.to(device)
